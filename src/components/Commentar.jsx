    ...
    <div 
        className={`px-4 pt-4 pb-2 rounded-xl border transition-all group hover:shadow-lg hover:-translate-y-0.5 ${
            isPinned 
                ...
                : 'bg-neutral-900/70 border-neutral-800 hover:bg-white/10'
        }`}
    >
        {isPinned && (
        ...
        <div className="flex items-start gap-3">
            {comment.profile_image ? (
                ...
                <div className={`p-2 rounded-full text-neutral-300 group-hover:bg-indigo-500/30 transition-colors ${
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                ...
                <input
                    ...
                    className="w-full p-3 rounded-xl bg-neutral-900/70 border border-neutral-800 text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                ...
                <textarea
                    ...
                    className="w-full p-4 rounded-xl bg-neutral-900/70 border border-neutral-800 text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none min-h-[120px]"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1400">
                ...
                <div className="flex items-center gap-4 p-4 bg-neutral-900/70 border border-neutral-800 rounded-xl">
                    {imagePreview ? (
                        ...
                        <div className="w-full">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-indigo-500/20 text-neutral-300 hover:bg-indigo-500/30 transition-all border border-dashed border-indigo-500/50 hover:border-indigo-500 group"
                            >
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-white to-neutral-400 rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
...
const Komentar = () => {
    ...
    return (
        <div className="w-full bg-gradient-to-b from-white/10 to-white/5 rounded-2xl  backdrop-blur-xl shadow-xl" data-aos="fade-up" data-aos-duration="1000">
            <div className="p-6 border-b border-neutral-800" data-aos="fade-down" data-aos-duration="800">
                <div className="flex items-center gap-3">
                    <div className="p-2 rounded-xl bg-indigo-500/20">
                        <MessageCircle className="w-6 h-6 text-neutral-300" />
                    </div>
                    <h3 className="text-xl font-semibold text-white">
                        Comments <span className="text-neutral-300">({totalComments})</span>
                    </h3>
                </div>
            </div>
                ...
                <div className="space-y-4 h-[328px] overflow-y-auto overflow-x-hidden custom-scrollbar pt-1 pr-1 " data-aos="fade-up" data-aos-delay="200">
                    ...
                    {comments.length === 0 && !pinnedComment ? (
                        <div className="text-center py-8" data-aos="fade-in">
                            <UserCircle2 className="w-12 h-12 text-neutral-300 mx-auto mb-3 opacity-50" />
