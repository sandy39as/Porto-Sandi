  ...
  return (
    <div className="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-xl border border-blue-500/10 hover:border-blue-500/30 transition-all duration-300 cursor-default">
      ...
      <div className="relative flex items-center gap-1.5 md:gap-2">
        <Icon className="w-3.5 h-3.5 md:w-4 md:h-4 text-neutral-300 group-hover:text-blue-300 transition-colors" />
...
const FeatureItem = ({ feature }) => {
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-neutral-900/70 transition-all duration-300 border border-transparent hover:border-neutral-800">
...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#0a0a1a] rounded-xl overflow-hidden relative">
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-neutral-900/70 p-2 md:p-3 rounded-lg border border-blue-500/20 transition-all duration-300 hover:scale-105 hover:border-blue-500/50 hover:shadow-lg">
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-neutral-900/70 p-2 md:p-3 rounded-lg border border-purple-500/20 transition-all duration-300 hover:scale-105 hover:border-purple-500/50 hover:shadow-lg">
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/SandiZR",
      };
        ...
        <meta
          ...
          content={
            project.Description
              ...
              : `Project ${project.Title} oleh Sandi Aditya Ramdani — Frontend Web Developer.`
          }
        />
        ...
        <div className="relative">
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
            <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
              <button
                onClick={() => navigate(-1)}
                className="group inline-flex items-center space-x-1.5 md:space-x-2 px-3 md:px-5 py-2 md:py-2.5 bg-neutral-900/70 backdrop-blur-xl rounded-xl text-white/90 hover:bg-white/10 transition-all duration-300 border border-neutral-800 hover:border-white/20 text-sm md:text-base"
              >
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
              ...
              <div className="space-y-6 md:space-y-10 animate-slideInRight">
                <div className="relative rounded-2xl overflow-hidden border border-neutral-800 shadow-2xl group">
                  ...
                  />
                  <div className="absolute inset-0 border-2 border-white/0 group-hover:border-neutral-800 transition-colors duration-300 rounded-2xl" />
                </div>
