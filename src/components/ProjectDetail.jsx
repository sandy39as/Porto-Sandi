...
const TechBadge = ({ tech }) => {
    ...
    return (
        <div className="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-white/[0.03] rounded-xl border border-neutral-800 hover:border-white/25 transition-all duration-300 cursor-default">
            <div className="absolute inset-0 bg-white/0 group-hover:bg-white/[0.04] transition-all duration-500" />

            <div className="relative flex items-center gap-1.5 md:gap-2">
                <Icon className="w-3.5 h-3.5 md:w-4 md:h-4 text-neutral-400 group-hover:text-white transition-colors" />
                <span className="text-xs md:text-sm font-medium text-neutral-300 group-hover:text-white transition-colors">
                    {tech}
                </span>
            </div>
        </div>
...
const FeatureItem = ({ feature }) => {
    return (
        <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/[0.04] transition-all duration-300 border border-transparent hover:border-neutral-800">
            <div className="relative mt-2">
                ...
                <div className="relative w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-white/80 group-hover:scale-125 transition-transform duration-300" />
            </div>
...
const ProjectStats = ({ project }) => {
    ...
    return (
        <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-neutral-950/70 rounded-xl overflow-hidden relative border border-neutral-800">
            <div className="absolute inset-0 bg-gradient-to-br from-white/[0.04] to-neutral-500/[0.03] opacity-80 blur-2xl z-0" />

            <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-black/30 p-2 md:p-3 rounded-lg border border-neutral-800 transition-all duration-300 hover:scale-105 hover:border-white/20 hover:shadow-[0_0_25px_rgba(255,255,255,0.05)]">
                <div className="bg-white/5 p-1.5 md:p-2 rounded-full border border-white/10">
                    <Code2
                        className="text-neutral-200 w-4 h-4 md:w-6 md:h-6"
                        strokeWidth={1.5}
                    />
                </div>
            ...
            <div className="min-h-screen bg-[#050505] px-[2%] sm:px-0 relative overflow-hidden">
                <div className="fixed inset-0 pointer-events-none">
                    <div className="absolute -inset-[10px] opacity-20">
                        <div className="absolute top-0 -left-4 w-72 md:w-96 h-72 md:h-96 bg-white rounded-full mix-blend-screen filter blur-3xl opacity-[0.08] animate-blob" />
                        <div className="absolute top-0 -right-4 w-72 md:w-96 h-72 md:h-96 bg-neutral-400 rounded-full mix-blend-screen filter blur-3xl opacity-[0.07] animate-blob animation-delay-2000" />
                        <div className="absolute -bottom-8 left-20 w-72 md:w-96 h-72 md:h-96 bg-neutral-600 rounded-full mix-blend-screen filter blur-3xl opacity-[0.08] animate-blob animation-delay-4000" />
                    </div>

                    <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff08_1px,transparent_1px),linear-gradient(to_bottom,#ffffff08_1px,transparent_1px)] bg-[size:24px_24px] opacity-70" />
                </div>
                ...
                <div className="relative z-10">
                    <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
                        <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
                            <button
                                onClick={() => navigate(-1)}
                                className="group inline-flex items-center space-x-1.5 md:space-x-2 px-3 md:px-5 py-2 md:py-2.5 bg-neutral-950/70 backdrop-blur-xl rounded-xl text-white/90 hover:bg-white/10 transition-all duration-300 border border-neutral-800 hover:border-white/20 text-sm md:text-base"
                            >
                            ...
                            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
                                <div className="space-y-4 md:space-y-6">
                                    ...
                                    <div className="relative h-1 w-16 md:w-24">
                                        <div className="absolute inset-0 bg-gradient-to-r from-white to-neutral-500 rounded-full animate-pulse" />
                                        <div className="absolute inset-0 bg-gradient-to-r from-white to-neutral-500 rounded-full blur-sm" />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4 md:space-y-6">
                                    <h3 className="text-lg md:text-xl font-semibold text-white/90 mt-[3rem] md:mt-0 flex items-center gap-2 md:gap-3">
                                        <Code2 className="w-4 h-4 md:w-5 md:h-5 text-neutral-300" />
                                        Technologies Used
                                    </h3>
                            ...
                            <div className="space-y-6 md:space-y-10 animate-slideInRight">
                                ...
                                <div className="bg-white/[0.02] backdrop-blur-xl rounded-2xl p-8 border border-neutral-800 space-y-6 hover:border-white/20 transition-colors duration-300 group">
                                    <h3 className="text-xl font-semibold text-white/90 flex items-center gap-3">
                                        <Star className="w-5 h-5 text-neutral-300 group-hover:rotate-[20deg] transition-transform duration-300" />
                                        Key Features
                                    </h3>
